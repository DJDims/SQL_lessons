...
class CoolerModel{
    public static function findAll() {
        $query = "SELECT * FROM `coolers_view` ORDER BY `name` ASC";
        $db = new database();
    ...
    public static function findById($id) {
        $query = "SELECT * FROM `coolers_view` WHERE `id` = $id";
        $db = new database();
    ...
    public static function findByOffest($offset, $limit) {
        $query = "SELECT * FROM `coolers_view` ORDER BY `name` ASC LIMIT $limit OFFSET $offset";
        $db = new database();
        $response = $db -> getAll($query);
    ...
    public static function countPages($limit) {
        $query = "SELECT COUNT(id) FROM `coolers`";
        $db = new database();
        $response = $db -> getOne($query);
